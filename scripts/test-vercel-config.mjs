...
assert.deepEqual(config.rewrites, ['/traces', '/registry', '/verify', '/s/:traceId'].map(source => ({source, destination: '/tools.html'})));
...
console.log('Vercel public routes and cache headers are configured.');
